                        ...
                        <div class="card-body">
                            <form   method="POST" action="signUp" >
                                ...
                                <div class="mb-3">
                                 ...
                                 <div class="mb-3">
                                    <label for="password" class="form-label">E-mail Password</label>
                                    <input type="password" class="form-control" id="password" name="mail_password" required>
                                </div>
                                ...
                                <div class="d-flex p-3 justify-content-center align-items-center"> 
                                    <div class="g-recaptcha" data-sitekey="6LcoxCwaAAAAACWvnojQhapZOz_RFSj5zzhlBeqe"></div>
                                </div>
